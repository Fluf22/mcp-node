/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 03da2b9a78a6fdb4137c7e55b7599eb4)
...
declare namespace Cloudflare {
	interface Env {
		...
		TOKEN: string;
		MCP_OBJECT: DurableObjectNamespace<import("./src/server/cloudflare-worker").AlgoliaMCP>;
	}
}
